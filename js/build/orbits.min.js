(function() {
    ...
    (function() {
        window.Orbits = m({
            ...
            settings: { earth: { x: 400, y: 300, r: 10, r2: 100, m: 50 } }
        });
        setInterval(function() {
            ...
            25);
        j.push(new r({ x: 400, y: 190, u: 1.5, v: 0, m: 25, c: "#FF0000" }));
        j.push(new r({ x: 400, y: 180, u: 1.5, v: 0, m: 25, c: "#FF0000" }));
        j.push(new r({ x: 400, y: 410, u: -1.5, v: 0, m: 25, c: "#FFFF00" }));
        j.push(new r({ x: 400, y: 400, u: -1.5, v: 0, m: 25, c: "#FFFF00" }));
        j.push(new r({ x: 290, y: 300, u: 0, v: 1.5, m: 25, c: "#FF00FF" }));
        j.push(new r({ x: 290, y: 290, u: 0, v: 1.5, m: 25, c: "#FF00FF" }));
        j.push(new r({ x: 510, y: 300, u: 0, v: -1.5, m: 25, c: "#00FFFF" }));
        j.push(new r({ x: 510, y: 290, u: 0, v: -1.5, m: 25, c: "#00FFFF" }))
    })()
})();