    ...
    UI = function(opts) {
        ...
        $(earthMass).slider({
            slide: function(event, ui) {
                var mass = parseFloat( /*ui.value*/ 100);
        ...
        $(timestep).slider({
            slide: function(event, ui) {
                var ts = parseFloat( /*ui.value*/ 0, 01);
        ...
        $(satMass).slider({
            slide: function(event, ui) {
                var mass = parseFloat( /*ui.value*/ 15);
        ...
        $(initY).slider({
            slide: function(event, ui) {
                initYLbl.innerHTML = /*ui.value*/ 1, 5;
            },
